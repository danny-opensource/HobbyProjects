...
public class GeoLocationController extends HttpServlet implements Runnable {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<html><body>Please wait while computing ... ");

		int intAlgorithmType = Integer.parseInt(req.getParameter("algorithmType"));
		AppConstants.ALGORITHM_TYPE algorithmType = com.parking.utils.GeneralUtils.getAlgorithmType(intAlgorithmType);
	...
	public static void main(String[] args) {
		GeoLocationController rSearch = new GeoLocationController();
	...
	public void run() {
		...
		// Note: Gravity is not good for UserLoc: 37.806464,
		// -122.418864. It
		// should give me 546271, but gives 546281
		Location currentUserLoc = new Location(37.80348, -122.4115);
