...
<title>Greedy Probabilistic</title>
			...
			<div data-role="collapsible">
				...
				<p>
					Total Trials Conducted: <label id="trialsCountZero"></label> <a
						...
						target="_blank"
						href="../GeoLocationAltered.jsp?userLocation=37.795752,-122.39434&blockLocation=37.8066485617,-122.4124854154">Show
						Navigation</a> <a href="SimulatedTrialData.jsp?congestion=0&origin=grp"
			...
			<div data-role="collapsible">
				...
				<p>
					Total Trials Conducted: <label id="trialsCountTen"></label> <a
						...
						href="../GeoLocationAltered.jsp?userLocation=37.795752,-122.39434&blockLocation=37.8066485617,-122.4124854154">Show
						Navigation</a> <a
						href="SimulatedTrialData.jsp?congestion=30&origin=grp"
						class="ui-btn ui-btn-inline" data-rel="dialog">Show Trial Data</a>
				</p>
			</div>
			<div data-role="collapsible">
				...
				<p>
					Total Trials Conducted: <label id="trialsCountTwenty"></label> <a
						...
						href="../GeoLocationAltered.jsp?userLocation=37.795752,-122.39434&blockLocation=37.8066485617,-122.4124854154">Show
						Navigation</a> <a
						href="SimulatedTrialData.jsp?congestion=50&origin=grp"
						class="ui-btn ui-btn-inline" data-rel="dialog">Show Trial Data</a>
				</p>
			</div>
			<div data-role="collapsible">
				...
				<p>
					Total Trials Conducted: <label id="trialsCountThirty"></label> <a
						...
						href="../GeoLocationAltered.jsp?userLocation=37.795752,-122.39434&blockLocation=37.8066485617,-122.4124854154">Show
						Navigation</a> <a
						href="SimulatedTrialData.jsp?congestion=70&origin=grp"
						class="ui-btn ui-btn-inline" data-rel="dialog">Show Trial Data</a>
				</p>
			</div>
			<div data-role="collapsible">
				...
				<p>
					Total Trials Conducted: <label id="trialsCountFourty"></label> <a
						...
						href="../GeoLocationAltered.jsp?userLocation=37.795752,-122.39434&blockLocation=37.8066485617,-122.4124854154">Show
						Navigation</a> <a
						href="SimulatedTrialData.jsp?congestion=90&origin=grp"
						class="ui-btn ui-btn-inline" data-rel="dialog">Show Trial Data</a>
				</p>
			</div>
		</div>
