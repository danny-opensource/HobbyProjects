			...
			<div data-role="collapsible">
				...
				<p>
					Total Trials Conducted: <label id="trialsCountTen"></label> <a
						...
						href="../GeoLocationAltered.jsp?userLocation=37.795752,-122.39434&blockLocation=37.8071031986,-122.4174351237">Show
						Navigation</a> <a
						href="SimulatedTrialData.jsp?congestion=30&origin=grd"
						class="ui-btn ui-btn-inline" data-rel="dialog">Show Trial Data</a>
				</p>
			</div>
			<div data-role="collapsible">
				...
				<p>
					Total Trials Conducted: <label id="trialsCountTwenty"></label> <a
						...
						href="../GeoLocationAltered.jsp?userLocation=37.795752,-122.39434&blockLocation=37.8071031986,-122.4174351237">Show
						Navigation</a> <a
						href="SimulatedTrialData.jsp?congestion=50&origin=grd"
						class="ui-btn ui-btn-inline" data-rel="dialog">Show Trial Data</a>
				</p>
			</div>
			<div data-role="collapsible">
				...
				<p>
					Total Trials Conducted: <label id="trialsCountThirty"></label> <a
						...
						href="../GeoLocationAltered.jsp?userLocation=37.795752,-122.39434&blockLocation=37.8077921947,-122.4194870247">Show
						Navigation</a> <a
						href="SimulatedTrialData.jsp?congestion=70&origin=grd"
						class="ui-btn ui-btn-inline" data-rel="dialog">Show Trial Data</a>
				</p>
			</div>
			<div data-role="collapsible">
				...
				<p>
					Total Trials Conducted: <label id="trialsCountFourty"></label> <a
						...
						href="../GeoLocationAltered.jsp?userLocation=37.795752,-122.39434&blockLocation=37.8077921947,-122.4194870247">Show
						Navigation</a> <a
						href="SimulatedTrialData.jsp?congestion=90&origin=grd"
						class="ui-btn ui-btn-inline" data-rel="dialog">Show Trial Data</a>
				</p>
			</div>
		</div>
